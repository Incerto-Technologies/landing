...
const IMPACT_METRICS = [
  ...
  {
    number: "12x",
    text: "Faster Query Creation",
    area: "md:col-span-1",
    background: "oncall",
  },
  {
    number: "70%",
    text: "Less Time Spent on Tasks",
    area: "md:col-span-1",
    background: "performance",
  },
  {
    number: "90%",
    text: "Accuracy with Context-Aware SQL",
    area: "md:col-span-1 ",
...
const GridItem = ({ area, title, percentage, background }: GridItemProps) => {
  return (
    <li
      ...
      <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3 transition-all duration-300 group-hover:border-primary/40">
        ...
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 md:p-2 z-10">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            {percentage && (
              <div className="text-[4.75rem] font-medium leading-[1.1] tracking-tight text-muted-foreground text-start transition-all duration-300 group-hover:text-foreground">
                {percentage}
              </div>
            )}
        ...
        <div
          className={cn(
            "absolute -right-1/3 -bottom-1/4 size-full opacity-30 transition-all  duration-500 group-hover:opacity-100",
            {
              "-rotate-45 opacity-60 -bottom-1/3  group-hover:-bottom-1/4 ":
                background === "globe",
              "bottom-0 scale-200 -right-2/3 group-hover:-right-2/5 ":
                background === "mttr",
              "opacity-30 group-hover:opacity-100 group-hover:-rotate-12 group-hover:-right-36 group-hover:bottom-2":
                background === "oncall",
              "-bottom-[70%] opacity-30  -right-[70%]  group-hover:-bottom-[50%] group-hover:-right-[50%] ":
                background === "performance",
              "group-hover:-rotate-180 opacity-30   group-hover:animate-spin group-hover:-right-36 group-hover:bottom-2":
                background === "cost",
              "group-hover:-rotate-180 opacity-30    group-hover:animate-ping  group-hover:-right-20 group-hover:bottom-2 ":
                background === "detection",
            }
          )}
        >
      ...
      return (
        ...
        >
          <path
            ...
            strokeOpacity="0.6"
          />
          <circle cx="50" cy="49" r="3" fill="currentColor" fillOpacity="1" />
          <path
            ...
            strokeOpacity="0.6"
          />
          <circle cx="60" cy="60" r="3" fill="currentColor" fillOpacity="1" />
        </svg>
      );
    case "cost":
      return (
    ...
    case "detection":
      return (
        ...
        >
          ...
          <circle cx="50" cy="50" r="1" fill="currentColor" fillOpacity="1" />
        </svg>
      );
    case "performance":
      return (
