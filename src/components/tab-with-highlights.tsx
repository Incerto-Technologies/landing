    ...
    panel: ({ isDark }: { isDark: boolean }) => (
      <VideoWithHighlights
        video={{
          ...
          sources: [
            {
              src: `https://xguihxuzqibwxjnimxev.supabase.co/storage/v1/object/public/videos/marketing/website/supabase-table-editor${
                isDark ? "" : "-light"
              }`,
              type: "video/mp4",
            },
    ...
    panel: ({ isDark }: { isDark: boolean }) => (
      <VideoWithHighlights
        video={{
          ...
          sources: [
            {
              src: `https://xguihxuzqibwxjnimxev.supabase.co/storage/v1/object/public/videos/marketing/website/supabase-rls${
                isDark ? "" : "-light"
              }`,
              type: "video/mp4",
            },
